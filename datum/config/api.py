...
from datum.config.clickhouse import DATABASE, LOG_TABLE, TABLE
...
class Settings:
    ...
    def __post_init__(self):
        ...
        self.check_identifier(self.log_table, "DATUM_LOG_TABLE")
    ...
    def from_env(cls) -> Settings:
        ...
        return cls(
            ...
            username=os.environ.get(
                "DATUM_CLICKHOUSE_USER",
                cls.username,
            ),
            password=os.environ.get(
                "DATUM_CLICKHOUSE_PASSWORD",
                cls.password,
            ),
            database=os.environ.get(
                "DATUM_CLICKHOUSE_DATABASE",
                cls.database,
            ),
            table=os.environ.get(
                "DATUM_CLICKHOUSE_TABLE",
                cls.table,
            ),
            ...
            timeout=float(
                os.environ.get("DATUM_TIMEOUT", cls.timeout)
            ),
        )